...
const ViewService = () => {
  ...
  const handleAccept = async (service) => {
    try {
      ...
      await axios.put(`http://localhost:4000/service/${_id}`, {
        customerId,
        customerName,
        registerNo,
        mobile,
        ...
        complaint,
        desireResolution,
        acceptStatus: "true", // Set acceptStatus to "true"
      });
  ...
  const handleReject = async (service) => {
    try {
      ...
      await axios.put(`http://localhost:4000/service/${_id}`, {
        ...
        complaint,
        desireResolution,
        acceptStatus: "false", // Set acceptStatus to "false"
      });
  ...
  return (
    ...
    <Typography variant="h4" className="text-black">
      Dashboard
          ...
          <Typography variant="h6" className="text-black" style={{ textDecoration: 'underline' }}>
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4">
            <Button
               ...
               style={{ borderRadius: '50px', backgroundColor: '#8d7a7a', color: 'white' }}
