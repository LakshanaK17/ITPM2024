      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="flex mt-4">
          <div className="w-full pl-1">
            <div className="bg-white bg-opacity-50 p-6 rounded-lg shadow-md" style={{ height: '100%', width: '100%' }}>
              ...
              <div className="flex flex-col">
                <div className="mb-4">
                  <Link to={`/view-complaint/${_id}`} className="no-underline">
                ...
                <div>
                  <Link to="/service-complaintstatus" className="no-underline">
