...
const ServiceComplaintFormPage = ({ onSubmit }) => {
  ...
  return (
    <div className="min-h-screen p-8 rounded-lg shadow-md flex items-center justify-center" style={{ backgroundImage: `url(${image2})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="flex items-center justify-center mb-8">
          ...
          <h1 className="font-bold mb-4 text-black text-center" style={{fontSize: '50px'}}>Service Type Complaint</h1>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center mb-4">
              ...
              <input type="text" id="customerId" name="customerId" value={formData.customerId} onChange={handleChange} onBlur={handleBlur} className="flex-grow p-3 border rounded text-lg" />
            </div>
            ...
            <div className="flex items-center mb-4">
              ...
              <input type="text" id="customerName" name="customerName" value={formData.customerName} onChange={handleChange} onBlur={handleBlur} className="flex-grow p-3 border rounded text-lg" />
            </div>
          ...
          <div className="flex items-center mb-4">
            ...
            <input type="text" id="registerNo" name="registerNo" value={formData.registerNo} onChange={handleChange} onBlur={handleBlur} className="flex-grow p-3 border rounded" />
          </div>
          ...
          <div className="flex items-center mb-4">
            ...
            <input type="text" id="mobile" name="mobile" value={formData.mobile} onChange={handleChange} onBlur={handleBlur} className="flex-grow p-3 border rounded" />
          </div>
          ...
          <div className="flex items-center mb-4">
            ...
            <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} onBlur={handleBlur} className="flex-grow p-3 border rounded" />
          </div>
          ...
          <div className="flex items-center mb-4">
            ...
            <input type="text" id="productName" name="productName" value={formData.productName} onChange={handleChange} onBlur={handleBlur} className="flex-grow p-3 border rounded" />
          </div>
          ...
          <div className="flex items-center mb-4">
            ...
            <input type="text" id="address1" name="address1" value={formData.address1} onChange={handleChange} onBlur={handleBlur} className="flex-grow p-3 border rounded" />
          </div>
          ...
          <div className="flex items-center mb-4">
            ...
            <input type="text" id="address2" name="address2" value={formData.address2} onChange={handleChange} onBlur={handleBlur} className="flex-grow p-3 border rounded" />
          </div>

          <div className="flex flex-wrap">
            <div className="flex items-center mb-4" style={{ width: '50%' }}>
              <label htmlFor="date" className="block mr-4 font-bold " style={{ minWidth: '150px', fontSize: '20px' }}>Date of the Complaint:</label>
              <input type="date" id="date" name="date" value={formData.date} onChange={handleChange} onBlur={handleBlur} className="p-3 border rounded w-full" style={{ minWidth: '200px' }} />
            </div>
            {/* <div className="flex items-center mb-4" style={{ width: '50%', paddingLeft: '20px' }}>
              <label htmlFor="timeOfComplaint" className="block mr-4 font-bold " style={{ minWidth: '150px', fontSize: '20px' }}>Time of the Complaint:</label>
              <input type="time" id="timeOfComplaint" name="timeOfComplaint" value={formData.timeOfComplaint} onChange={handleChange} onBlur={handleBlur} className="p-3 border rounded w-full" style={{ minWidth: '200px' }} />
            </div> */}
          </div>

          <div className="flex items-center mb-4">
            <label htmlFor="complaint" className="block mr-4 font-bold " style={{ minWidth: '150px', fontSize: '20px' }}>Incident Details/Complaint:</label>
            <textarea id="complaint" name="complaint" value={formData.complaint} onChange={handleChange} onBlur={handleBlur} className="flex-grow p-5 border rounded"></textarea>
          </div>
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <button type="submit" className="bg-[#4b2d2b] hover:bg-blue-400 text-black font-extrabold py-4 px-8 rounded-xl" style={{ fontSize: '20px' }}>Submit</button>
          </div>
        </form>
