...
const WebViewComplaintPage = () => {
  ...
  return (
    <div className="min-h-screen p-8 rounded-lg shadow-md flex items-center justify-center" style={{ backgroundImage: `url(${side})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className="bg-gray-200 bg-opacity-75 w-full max-w-full rounded-xl p-12">
        ...
        <div className="bg-[#968d7c] bg-opacity-75  rounded-xl p-12" >
          <div className="mb-4">
            {!editMode && (
